...
namespace WebApplication.Controllers
{
    ...
    {
        public ImproveController(ShopContext db)
        {
            _dal = new ImproveDataAccessLayer(db);
            _db = db;
        }
        ...
        {
            List<CoffeeType> coffeeTypes = new List<CoffeeType> { new CoffeeType { CoffeeTypeId = 1 } };
        ...
        private ImproveDataAccessLayer _dal;
